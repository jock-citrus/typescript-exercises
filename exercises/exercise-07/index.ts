...
Higher difficulty exercise:
    ...
    and also have type PersonTypeEnum.powerUser without duplicating
...
function isAdmin(person: Person): person is Admin {
  return person.type === PersonTypeEnum.admin;
}

function isUser(person: Person): person is User {
  return person.type === PersonTypeEnum.user;
}

function isPowerUser(person: Person): person is PowerUser {
  return person.type === PersonTypeEnum.powerUser;
}
